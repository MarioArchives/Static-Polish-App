...
const SENTENCES = [
  // Mianownik
  { c: 'nom', s: 'To{this} jest{is} mój{my} ___.', base: 'brat', gloss: 'brother', a: ['brat'], en: 'This is my brother.', why: 'After “to jest” the noun stays in the nominative. Only plain “jest” would call for the instrumental.' },
  ...
  { c: 'nom', s: 'To{these} są{are} dobre{good} ___.', base: 'książka', hint: 'plural', gloss: 'book', a: ['książki'], en: 'These are good books.', why: 'Feminine nominative plural is -y, but after k and g it is written -i.' },
  { c: 'nom', s: 'Ci{these} ___ są{are} z{from} Krakowa{Kraków}.', base: 'Polak', hint: 'plural', gloss: 'Pole, Polish man', a: ['Polacy'], en: 'These Poles are from Kraków.', why: 'Men’s nominative plural softens k to c and adds -y.' },
  { c: 'nom', s: 'Moi{my} ___ mieszkają{live} w{in} Gdańsku{Gdańsk}.', base: 'brat', hint: 'plural', gloss: 'brother', a: ['bracia'], en: 'My brothers live in Gdańsk.', why: 'Brat has an irregular plural: bracia. It is the subject, so nominative.' },
  { c: 'nom', s: 'Te{these} ___ są{are} duże{big}.', base: 'okno', hint: 'plural', gloss: 'window', a: ['okna'], en: 'These windows are big.', why: 'Neuter nouns always form the nominative plural with -a.' },
  { c: 'nom', s: '___ pracują{work} w{in} szpitalu{hospital}.', base: 'dobry lekarz', hint: 'plural', gloss: 'good doctor', a: ['Dobrzy lekarze'], en: 'Good doctors work in a hospital.', why: 'Lekarz ends in a hardened consonant, so it takes -e. The adjective for men softens r to rz: dobrzy.' },
  { c: 'nom', s: 'Gdzie{where} są{are} moje{my} ___?', base: 'klucz', hint: 'plural', gloss: 'key', a: ['klucze'], en: 'Where are my keys?', why: 'After a hardened consonant such as cz, the nominative plural ending is -e.' },
  { c: 'nom', s: 'Ci{these} ___ są{are} bardzo{very} mili{kind}.', base: 'pan', hint: 'plural', gloss: 'gentleman, sir', a: ['panowie'], en: 'These gentlemen are very kind.', why: 'Titles and family words for men take -owie in the nominative plural.' },
  { c: 'nom', s: 'Te{these} ___ są{are} drogie{expensive}.', base: 'dom', hint: 'plural', gloss: 'house', a: ['domy'], en: 'These houses are expensive.', why: 'A masculine thing ending in a hard consonant takes -y in the nominative plural.' },
  { c: 'nom', s: 'W{in} klasie{classroom} są{are} ___.', base: 'dziecko', hint: 'plural', gloss: 'child', a: ['dzieci'], en: 'There are children in the classroom.', why: 'Dziecko has an irregular plural: dzieci. It is the subject of “są”, so nominative.' },
  { c: 'nom', s: 'Nasi{our} ___ są{are} mili{kind}.', base: 'sąsiad', hint: 'plural', gloss: 'neighbour', a: ['sąsiedzi'], en: 'Our neighbours are kind.', why: 'Men’s plural -i softens d to dzi, and the a inside the word shifts to e.' },
  ...
  { c: 'gen', s: 'To{this} jest{is} samochód{car} mojego{my} ___.', base: 'brat', gloss: 'brother', a: ['brata'], en: 'This is my brother’s car.', why: 'Possession uses the genitive. Masculine nouns for people take -a.' },
  ...
  { c: 'gen', s: 'Piję{I drink} kawę{coffee} bez{without} ___.', base: 'cukier', gloss: 'sugar', a: ['cukru'], en: 'I drink coffee without sugar.', why: '“Bez” takes the genitive. Substances take -u, and the e in cukier drops out.' },
  { c: 'gen', s: 'W{in} tym{this} mieście{city} jest{is} dużo{a lot of} ___.', base: 'student', hint: 'plural', gloss: 'student', a: ['studentów'], en: 'There are a lot of students in this city.', why: 'Quantity words like “dużo” take the genitive plural. Masculine hard stems take -ów.' },
  ...
  { c: 'gen', s: 'To{this} prezent{present} dla{for} ___.', base: 'mama', gloss: 'mum', a: ['mamy'], en: 'This is a present for mum.', why: '“Dla” takes the genitive. Feminine hard stem, so -y.' },
  ...
  { c: 'gen', s: 'W{in} tym{this} pokoju{room} nie_ma{there are no} ___.', base: 'okno', hint: 'plural', gloss: 'window', a: ['okien'], en: 'There are no windows in this room.', why: '“Nie ma” takes the genitive. Neuter plural drops the ending, and an e appears between k and n.' },
  ...
  // Celownik
  { c: 'dat', s: 'Daję{I’m giving} prezent{present} ___.', base: 'siostra', gloss: 'sister', a: ['siostrze'], en: 'I’m giving a present to my sister.', why: 'The receiver is in the dative. Feminine hard stems take -e, and r softens to rz.' },
  ...
  { c: 'dat', s: 'Dziękuję{I thank} ___ za{for} pomoc{help}.', base: 'pan', gloss: 'sir, you (formal)', a: ['panu'], en: 'Thank you for your help, sir.', why: '“Dziękować” takes the dative. Pan is on the short -u list.' },
  { c: 'dat', s: 'Kupuję{I’m buying} kwiaty{flowers} ___.', base: 'mama', gloss: 'mum', a: ['mamie'], en: 'I’m buying flowers for mum.', why: 'The receiver is in the dative. Feminine hard stem takes -e, and m softens to mi.' },
  { c: 'dat', s: 'Nauczyciel{teacher} tłumaczy{explains} gramatykę{grammar} ___.', base: 'student', hint: 'plural', gloss: 'student', a: ['studentom'], en: 'The teacher explains grammar to the students.', why: 'Dative plural is -om for every noun.' },
  { c: 'dat', s: 'Ten{this} film{film} podoba{pleases} się{itself} ___.', base: 'Marek', gloss: 'Marek', a: ['Markowi'], en: 'Marek likes this film.', why: 'With “podobać się” the person who likes is in the dative. Regular masculine -owi, and the e in Marek drops.' },
  { c: 'dat', s: 'Opowiadam{I’m telling} bajkę{fairy tale} ___.', base: 'dziecko', gloss: 'child', a: ['dziecku'], en: 'I’m telling the child a fairy tale.', why: 'The listener is in the dative. Neuter nouns take -u.' },
  { c: 'dat', s: 'Ufam{I trust} mojej{my} ___.', base: 'koleżanka', gloss: 'female friend', a: ['koleżance'], en: 'I trust my friend.', why: '“Ufać” takes the dative. Feminine -e softens k to c.' },
  ...
  { c: 'dat', s: 'Daję{I’m giving} wodę{water} ___.', base: 'pies', gloss: 'dog', a: ['psu'], en: 'I’m giving the dog water.', why: 'The receiver is in the dative. Pies is on the short -u list, and its e drops.' },
  { c: 'dat', s: 'Wysyłam{I’m sending} e-mail{email} ___.', base: 'profesor', gloss: 'professor', a: ['profesorowi'], en: 'I’m sending the professor an email.', why: 'The receiver is in the dative. Regular masculine ending -owi.' },
  { c: 'dat', s: 'Pożyczam{I’m lending} rower{bike} ___.', base: 'dobry kolega', gloss: 'good friend', a: ['dobremu koledze'], en: 'I’m lending my bike to a good friend.', why: 'Kolega ends in -a, so it declines like a feminine noun: g softens to dz. The adjective stays masculine: -emu.' },
  ...
  { c: 'acc', s: 'Kocham{I love} moje{my} ___.', base: 'dziecko', gloss: 'child', a: ['dziecko'], en: 'I love my child.', why: 'Neuter nouns look the same in the accusative and the nominative.' },
  { c: 'acc', s: 'Znam{I know} tych{these} ___.', base: 'student', hint: 'plural', gloss: 'student', a: ['studentów'], en: 'I know these students.', why: 'For groups of men the accusative plural equals the genitive plural: -ów.' },
  ...
  { c: 'ins', s: 'Ona{she} jest{is} ___.', base: 'lekarka', gloss: 'female doctor', a: ['lekarką'], en: 'She is a doctor.', why: 'A profession after “jest” takes the instrumental. Feminine -ą.' },
  { c: 'ins', s: 'Piję{I drink} kawę{coffee} z{with} ___.', base: 'mleko', gloss: 'milk', a: ['mlekiem'], en: 'I drink coffee with milk.', why: '“Z” meaning “with” takes the instrumental. After k the ending is -iem.' },
  { c: 'ins', s: 'Jadę{I’m travelling} do{to} pracy{work} ___.', base: 'autobus', gloss: 'bus', a: ['autobusem'], en: 'I go to work by bus.', why: 'Means of transport take the instrumental with no preposition. Masculine -em.' },
  ...
  { c: 'ins', s: 'Idę{I’m going} do{to} kina{cinema} z{with} ___.', base: 'przyjaciel', hint: 'plural', gloss: 'close friend', a: ['przyjaciółmi'], en: 'I’m going to the cinema with friends.', why: 'Przyjaciele is one of the few nouns with the short plural ending -mi, and the stem changes to przyjaciół-.' },
  { c: 'ins', s: 'Kot{cat} śpi{sleeps} pod{under} ___.', base: 'stół', gloss: 'table', a: ['stołem'], en: 'The cat sleeps under the table.', why: '“Pod” for position takes the instrumental. Masculine -em, and ó turns to o.' },
  { c: 'ins', s: 'On{he} jest{is} ___.', base: 'dobry nauczyciel', gloss: 'good teacher', a: ['dobrym nauczycielem'], en: 'He is a good teacher.', why: 'Instrumental after “jest”. The adjective takes -ym and the noun -em.' },
  ...
  { c: 'ins', s: 'Marek{Marek} jest{is} ___.', base: 'Polak', gloss: 'Pole, Polish man', a: ['Polakiem'], en: 'Marek is Polish.', why: 'Nationality after “jest” takes the instrumental. After k the ending is -iem.' },
  ...
  { c: 'loc', s: 'Książka{book} leży{lies} na{on} ___.', base: 'stół', gloss: 'table', a: ['stole'], en: 'The book is on the table.', why: '“Na” for position takes the locative. The ending -e softens ł to l, and ó turns to o.' },
  ...
  { c: 'loc', s: 'Oglądam{I’m watching} film{film} w{in} ___.', base: 'kino', gloss: 'cinema', a: ['kinie'], en: 'I’m watching a film at the cinema.', why: '“W” for position takes the locative. Hard stem in n, so -ie.' },
  ...
  { c: 'loc', s: 'Po{after} ___ idę{I go} na{for} spacer{walk}.', base: 'obiad', gloss: 'lunch, dinner', a: ['obiedzie'], en: 'After lunch I go for a walk.', why: '“Po” meaning “after” takes the locative. The d softens to dzi, and the a shifts to e.' },
  ...
  { c: 'loc', s: 'Mój{my} brat{brother} pracuje{works} w{in} ___.', base: 'Warszawa', gloss: 'Warsaw', a: ['Warszawie'], en: 'My brother works in Warsaw.', why: '“W” for position takes the locative. Hard stem in w, so -ie.' },
  ...
  { c: 'loc', s: 'Oni{they} są{are} w{at} ___.', base: 'teatr', gloss: 'theatre', a: ['teatrze'], en: 'They are at the theatre.', why: '“W” for position takes the locative. The ending -e softens r to rz.' },

  // Wołacz
  { c: 'voc', s: 'Dzień_dobry{good morning}, panie{sir} ___!', base: 'profesor', gloss: 'professor', a: ['profesorze'], en: 'Good morning, professor!', why: 'You are addressing him directly. Masculine hard stem takes -e, and r softens to rz.' },
  ...
  { c: 'voc', s: 'Drogi{dear} ___, dziękuję{thank you} za{for} list{letter}.', base: 'Piotr', gloss: 'Piotr', a: ['Piotrze'], en: 'Dear Piotr, thank you for the letter.', why: 'Letters open with the vocative. Masculine -e softens r to rz. The adjective stays as in the nominative.' },
  ...
  { c: 'voc', s: 'Dzień_dobry{good morning}, ___ doktorze{doctor}!', base: 'pan', gloss: 'sir', a: ['panie'], en: 'Good morning, doctor!', why: 'With titles the vocative is required. Pan takes -e, and n softens to ni.' },
  ...
  { c: 'voc', s: 'Drodzy{dear} ___, zaczynamy{we’re starting}!', base: 'student', hint: 'plural', gloss: 'student', a: ['studenci'], en: 'Dear students, we’re starting!', why: 'In the plural the vocative is identical to the nominative.' },
  { c: 'voc', s: '___, chodź{come} na{for} obiad{lunch}!', base: 'syn', gloss: 'son', a: ['Synu'], en: 'Son, come for lunch!', why: 'Syn is an exception that takes -u, in the vocative as in the locative.' },
];
